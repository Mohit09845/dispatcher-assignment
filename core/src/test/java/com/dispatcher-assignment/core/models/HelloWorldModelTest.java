 ...
 */
package com.dispatcher-assignment.core.models;
...
import com.dispatcher-assignment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "dispatcher-assignment/components/helloworld");
